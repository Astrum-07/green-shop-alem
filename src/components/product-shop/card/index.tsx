...
const Card: FC<ShopCartType> = (props) => {
  ...
  return (
    <div className="my-5 bg-[#fbfbfb] p-2 flex items-center justify-between rounded-lg">
      <div className="flex items-center gap-4 w-[40%]">
        <img className="w-17.5 h-17.5" src={main_image} alt="" />
        <div>
      ...
      <div className="flex items-center gap-3 w-[20%]">
        <button
          ...
          className="w-6.25 h-6.25 bg-[#46A358] rounded-full text-white"
        >
          -
        </button>
